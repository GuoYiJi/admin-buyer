  ...
  <div class="home">
    <div class="line-box">
      <div class="line b_line">
        ...
        <input class="input_text" placeholder="请输入成团数量">
      </div>
      <div class="line b_line" >
      ...
      <div class="line b_line">
        ...
        <input class="input_text" placeholder="请输入限购次数">
      </div>
      <!-- <div class="line b_line">
      ...
      <div class="line">
        ...
        <input class="input_text" placeholder="请输入限购件数">
      </div>
...
export default {
  ...
  methods: {
    ...
    toRoute(path){
      this.$router.push({path: '/pages/home/shopMgr/' + path, query: {type: 'collage'}})
    }
  },
  mounted() {
    console.log(this.$route.query.num)
    if(this.$route.query.num) {
      this.addShop = this.$route.query.num
    }
  }
};
</script>
