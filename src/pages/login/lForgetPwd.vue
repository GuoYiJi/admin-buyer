...
<div class="wrapper">
  <div class="login">
    <div class="line">
      ...
      <input v-model.lazy="phone" class="input" type="number" placeholder="输入手机号"/>
    </div>
    <div class="line">
      <i class="code-icon phone-icon"></i>
      <input v-model.lazy="code" class="input" type="number" placeholder="输入短信验证码"/>
    ...
    <div class="line">
      ...
      <input v-show="pwdShow" v-model.lazy="pwd" class="input" type="number" placeholder="请输入密码"/>
      <i class="showPwd-icon" @click="showPwd"></i>
    </div>
    <div class="login-btn">
      <p @click="toHome"><btn :title="'重置密码'"/></p>
    </div>
