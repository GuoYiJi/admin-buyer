...
const Base64 = require('@/assets/js/aliyun/Base64.js');//Base64,hmac,sha1,crypto相关算法
//参考这里https://github.com/peterhuang007/weixinFileToaliyun.git

require('@/assets/js/aliyun/hmac.js');
require('@/assets/js/aliyun/sha1.js');
const Crypto = require('@/assets/js/aliyun/crypto.js');
